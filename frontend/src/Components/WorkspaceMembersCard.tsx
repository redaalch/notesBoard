...
export interface WorkspaceMembersCardProps {
  workspaceId: string;
  canManage?: boolean;
}
...
const ROLE_OPTIONS: RoleOption[] = Object.entries(ROLE_LABELS)
...
const WorkspaceMembersCard = ({ workspaceId, canManage }: WorkspaceMembersCardProps) => {
  ...
  const inviteDisabled =
    !email.trim() || inviteMutation.isPending || !canManageMembers;
