...
const HistoryItem = ({ event, actor, showDiff }: HistoryItemProps) => {
...
export interface NoteHistoryTimelineProps {
  history?: HistoryEvent[];
  actors?: Record<string, HistoryActor>;
  noteTitle?: string;
}

const NoteHistoryTimeline = ({
  history = [],
  actors = {},
  noteTitle,
